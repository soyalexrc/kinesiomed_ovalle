                    ...
                    {data.map((item, index) => (
                        <>
                            <div key={item.id}
                                ...
                                <div
                                    className={`rounded-2xl min-w-[52px] min-h-[52px] ${index % 2 === 0 ? 'bg-brandSecondary/10 ' : 'bg-white'}`}/>
                            ...
                            <div key={item.id}
                                 className={`flex md:hidden col-span-2 px-8 md:col-span-1 border-b-[1px] items-center gap-4 h-[180px] ${index > 2  ? ` bg-brand ${index === 5 ? 'rounded-b-2xl' : ''}` : `bg-brandSecondary/10 ${index === 0 ? 'rounded-t-2xl' : index === 4 ? 'rounded-bl-2xl' : ''}`}`}>
                                <div
                                    className={`rounded-2xl min-w-[52px] min-h-[52px] ${index < 3 ? 'bg-brandSecondary/10 ' : 'bg-white'}`}/>
                                <div className="max-w-[300px]">
